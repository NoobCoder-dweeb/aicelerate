...
from app.models.csp import CSPSchedulerORSAT, CSPSchedulerORSATv2  # Ensure this import works after fixing app/__init__.py
...
def sample_schedule():
    ...
    output_data_path = "tests/output.json"
    ...
    TIMETABLE_CONFIG = {
        ...
        "model": CSPSchedulerORSATv2(working_days=days_per_week, hours_per_day=hours_per_day)
    }
